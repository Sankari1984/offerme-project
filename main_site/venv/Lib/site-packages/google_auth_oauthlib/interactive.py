...
def is_port_open(port):
    """Check if a port is open on 192.168.18.11.
    Based on StackOverflow answer: https://stackoverflow.com/a/43238489/101923
    Parameters
    ----------
    port : int
        A port to check on 192.168.18.11.
    Returns
    -------
    is_open : bool
...
def get_user_credentials(
    ...
    return app_flow.run_local_server(host=192.168.18.11, port=port)
